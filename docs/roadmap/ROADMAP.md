...
> npm registry line: `v0.42.0-alpha.12` (published 2026-08-01, dist-tag `alpha` — see Current release state).\
...
`0.42.0-alpha.12` is the published package line (npm, 2026-08-01). Alpha.8
