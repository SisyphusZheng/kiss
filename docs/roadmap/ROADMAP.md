...
> Source package line: `v0.42.0-alpha.17`.\
> npm registry line: `v0.42.0-alpha.17` (published 2026-08-14, dist-tag `alpha` — see Current release state).\
> Active execution target: `v0.42.0-alpha.17`.\
...
`0.42.0-alpha.17` is the published package line (npm, 2026-08-14). Alpha.8
