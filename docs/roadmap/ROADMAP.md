...
| v0.41.0-alpha.6 | App Protocol Architecture Hardening                | Sync product truth, make App own RouteGraph/RenderPipeline/RequestContext, keep Vite/Hono/Nitro as official adapters, close CodeQL/trust-boundary backlog, and promote Reader into regression dogfood. | Planned                  |
