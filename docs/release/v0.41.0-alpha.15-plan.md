...
- [x] Update action version comments and mechanically validate comment/pin
      agreement.
- [x] Decide #393: the external automated review bot becomes advisory with Dependabot skip semantics, or
...
| A       | P2 Actions runtime and external review disposition | `dev`         |
