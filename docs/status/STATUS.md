...
## Current Version Line: v0.41.0-alpha1 Active (Cleanup-Train Patch → next v0.41.0 npm Distribution Pivot)

v0.41.0-alpha1 is the active package line. v0.41.0 (next) pivots openElement distribution from
