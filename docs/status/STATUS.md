...
Alpha.15 is the current published and verified line. Alpha.16 is the active
audit-driven correctness reset (ADR-0116) before a separate decision about
stable `0.41.0`.
...
## Alpha.16 active gates

| Condition                                        | State                  |
| ------------------------------------------------ | ---------------------- |
| ADR-0116, alpha.16 plan and drift clearance      | In progress            |
| P0 event-marker and static-props correctness     | Pending                |
| P0 island chunk matching and npm `latest` policy | Pending                |
| P0 #460 Windows starter build fix                | Pending                |
| P1/P2 audit packages                             | Scheduled              |
| External adopter pilot #390                      | Pending human evidence |
| Alpha.16 npm, tag, prerelease and final evidence | Pending                |

## Current risks

1. External adoption remains the primary product risk.
2. Current-document version drift needs stronger mechanical rejection;
   alpha.16 package C schedules the missing doc-anchor gate.
...
5. UI remains optional until alpha.16 records its stable scope.

## Release direction

| Version           | Focus                                            |
| ----------------- | ------------------------------------------------ |
| `0.41.0-alpha.15` | Current verified published baseline              |
| `0.41.0-alpha.16` | Audit-driven correctness reset (ADR-0116)        |
| `0.41.0`          | Separate stable decision after alpha.16 evidence |
...
- Alpha.16 scope decision: [`ADR-0116`](../adr/ADR-0116-audit-driven-alpha16-correctness-reset.md)
- Current package surface: [`PACKAGE_SURFACE.md`](../current/PACKAGE_SURFACE.md)
- Alpha.15 immutable release record: [`v0.41.0-alpha.15.md`](../release/v0.41.0-alpha.15.md)
