...
deno task typecheck</code></pre></code-block>
          ...
          <code-block><pre><code># ADR-XXX: 标题
...
这个决策的影响</code></pre></code-block>
          ...
          <h2>问题反馈</h2>
          <ul>
            <li>GitHub Issues: <a href="https://github.com/SisyphusZheng/kiss/issues" target="_blank">https://github.com/SisyphusZheng/kiss/issues</a></li>
