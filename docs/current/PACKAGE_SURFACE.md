...
This is the v0.40.2 11-package product-line truth table.
...
ADR-0105 approves the v0.40.2 breaking cleanup train and the 14-to-11 package
graph collapse.

## Current 11-package surface

| Package                     | Class          | v0.40.2 decision                                                                             |
| --------------------------- | -------------- | -------------------------------------------------------------------------------------------- |
...
v0.40.2 removes historical and collapsed packages from the current workspace and
publish order:
...
The v0.40.2 cleanup train is manually approved breaking work consolidated into
the v0.40.2 release, not normal AutoFlow patch automation. AutoFlow3 patch
