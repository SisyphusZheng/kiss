# v0.40.3 Version Plan - Product-Line Cleanup
...
The current local package line is `v0.40.3`. All cleanup-train work is
consolidated into the v0.40.3 release. The cleanup was manually approved as a
...
All workstreams are complete in v0.40.3.

### v0.40.3 - Governance And Repo Hygiene
...
### v0.40.3 - Package Graph Collapse To 11
...
### v0.40.3 - Signal Candidate And Code Clean
...
### v0.40.3 - Post-Cleanup Truth Audit Follow-Up

The 2026-06-15 repo read-through found that the implementation was ahead of the
planning layer. The follow-up is now part of v0.40.3 closure:

- [x] Reconcile ADR-0105 with the actual v0.40.3 package graph:
