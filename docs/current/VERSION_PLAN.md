# v0.40.4 Version Plan - Product-Line Cleanup
...
The current local package line is `v0.40.4`. All cleanup-train work is
consolidated into the v0.40.4 release. The cleanup was manually approved as a
...
All workstreams are complete in v0.40.4.

### v0.40.4 - Governance And Repo Hygiene
...
### v0.40.4 - Package Graph Collapse To 11
