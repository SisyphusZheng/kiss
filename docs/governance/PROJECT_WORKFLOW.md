...
Current execution anchor: package line `v0.41.0-alpha.4`, active execution line
`v0.41.0-alpha.4`, active version plan `docs/current/VERSION_PLAN.md`, and product
