...
Current execution anchor: package line `v0.41.0-alpha.1`, active execution line
`v0.41.0-alpha.1`, active version plan `docs/current/VERSION_PLAN.md`, and product
