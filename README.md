...
**JSX-first Web Components platform. Package line: `0.40.4` (`v0.40.4`
release). Active execution: `v0.40.4` Elements + Preact + Repository
Slimming.**
...
All 11 current workspace packages are aligned at **0.40.4** (`v0.40.4`) under
[`@openelement`](https://jsr.io/@openelement). The active execution line is
**v0.40.4**. ADR-0101 keeps AutoFlow3 as the single workflow/gate control plane
