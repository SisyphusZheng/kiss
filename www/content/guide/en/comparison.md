...
| Enhance | HTML-first WC fullstack peer     | You prefer HTML templates over JSX.                       |
...
- You want DSD-native SSR out of the box.
- You want JSX authoring that compiles to standards-based Custom Elements.
- You need file-based routing, API routes, and islands in one framework.
