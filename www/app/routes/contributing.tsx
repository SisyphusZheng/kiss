...
export class ContributingPage extends OpenElement {
  ...
  private _renderEn() {
    return (
      <><open-page-hero variant="technical"><span slot="eyebrow">Maintainer guide</span><span slot="title">Contributing</span><span slot="lede">A precise, Deno-first contributor workflow for the Web Standards Lab.</span><open-artifact-panel slot="artifact"><span slot="label">contribution contract</span><span slot="meta">public repository</span><p>Use the same product interfaces, checks and release evidence that the framework requires of itself.</p></open-artifact-panel></open-page-hero><open-reading-shell rail footer><open-page-rail slot="rail" items='[{"id":"development-setup","label":"Development Setup"},{"id":"deno-toolchain","label":"Deno-first Toolchain"},{"id":"conventions","label":"Development Conventions"},{"id":"release-process","label":"Release Process"}]'></open-page-rail><div class="container">
        <open-section-frame><span slot="index">01 / setup</span><span slot="title" id="development-setup">Development Setup</span><span slot="copy">Clone the repository and establish the same verified Deno workflow used by maintainers.</span>
        <open-code-block>
...
deno task dev</code></pre>
        </open-code-block></open-section-frame>
        <open-section-frame><span slot="index">02 / toolchain</span><span slot="title" id="deno-toolchain">Deno-first Toolchain</span>
        <p>
        ...
        </p></open-section-frame>
        <open-section-frame><span slot="index">03 / conventions</span><span slot="title" id="conventions">Development Conventions</span>
        <ul>
          <li>
        ...
        </ul></open-section-frame>
        <open-section-frame><span slot="index">04 / release</span><span slot="title" id="release-process">Release Process</span>
        <ol>
          <li>
