    ...
    return (
      <open-reading-shell rail>
        ...
        <div class='container'>
          ...
          <p>
            DSD components need no framework virtual DOM runtime. Client JS is emitted only
            when islands or enhanced forms exist; pure-static pages stay script-free. Islands
            load on-demand by strategy.
          </p>
        </div>
      </open-reading-shell>
    );
