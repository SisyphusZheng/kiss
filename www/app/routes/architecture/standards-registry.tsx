  ...
  override render() {
    return (
      <open-reading-shell rail>
        <open-page-rail
          slot='rail'
          items='[{"id":"elements-dsd","label":"Elements + DSD","level":3},{"id":"request-semantics","label":"Request semantics","level":3},{"id":"five-package-ownership","label":"Five-package ownership","level":3}]'
        >
        </open-page-rail>
        <div class='container'>
          ...
          <open-artifact-panel>
            <span slot='label'>browser standards contract</span>
            <span slot='meta'>platform ownership</span>
            <div class='registry-grid'>
              <open-card variant='artifact'>
                <h3 id='elements-dsd'>Elements + DSD</h3>
                <p>
                  Standard Custom Elements and Declarative Shadow DOM define the durable component
                  boundary.
                </p>
              </open-card>
              <open-card>
                ...
                <p>
                  Request, Response and FormData guide future application interaction without
                  inventing a proprietary transport.
                </p>
              </open-card>
              <open-card>
                <h3 id='five-package-ownership'>Five-package ownership</h3>
                <p>
                  Element, App, Adapter Vite, Create and optional UI are the current consumer
                  surface; internal contracts stay internal.
                </p>
              </open-card>
            </div>
          </open-artifact-panel>
