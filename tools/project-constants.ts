export const PACKAGE_VERSION = '0.42.0-alpha.10';
export const PACKAGE_VERSION_TAG = `v${PACKAGE_VERSION}`;
export const ACTIVE_EXECUTION_VERSION = 'v0.42.0-alpha.10';
...
export const PREVIOUS_PACKAGE_VERSION = '0.42.0-alpha.9';
...
export const PREVIOUS_RELEASE_THEME = 'audit-to-plan execution';
