...
export const PACKAGE_VERSION = '0.43.0-alpha.2';
...
export const PREVIOUS_PACKAGE_VERSION = '0.43.0-alpha.1';
...
export const PREVIOUS_RELEASE_THEME =
  'foundation train: hydration diagnostics, honest runtimes, WC SSR corpus';
