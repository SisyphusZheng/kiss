export const PACKAGE_VERSION = '0.42.0-alpha.13';
export const PACKAGE_VERSION_TAG = `v${PACKAGE_VERSION}`;
export const ACTIVE_EXECUTION_VERSION = 'v0.42.0-alpha.13';
...
export const PREVIOUS_PACKAGE_VERSION = '0.42.0-alpha.12';
...
export const PREVIOUS_RELEASE_THEME = 'round-6 audit remediation';
