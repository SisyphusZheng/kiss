...
export const NEXT_EXECUTION_VERSION = 'v0.43.0';
...
export const PREVIOUS_PACKAGE_VERSION = '0.43.0-alpha.2';
...
export const PREVIOUS_RELEASE_THEME =
  'Universal WC admission + the Supabase × Cloudflare production closure';
