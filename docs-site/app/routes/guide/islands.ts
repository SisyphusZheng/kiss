...
export class IslandsGuidePage extends LitElement {
  static styles = css`
    ...
    .comparison-item.spa {
      border-color: var(--wa-color-danger-200, #fecaca);
    }

    .comparison-item.kiss {
      border-color: var(--wa-color-success-200, #bbf7d0);
          ...
          <table>
            ...
            <tbody>
              <tr>
                ...
                <td>SSR + Declarative Shadow DOM</td>
                <td><strong>0 KB</strong></td>
                <td>Blog, documentation</td>
              </tr>
              <tr>
                <td><strong>2</strong></td>
                <td>Partial Islands with hydration</td>
                <td>~6 KB / island</td>
                <td>Counter, theme toggle</td>
              </tr>
              <tr>
                <td><strong>4</strong></td>
                <td>Full client-side navigation</td>
...
export class CounterIsland extends LitElement {
  ...
  render() {
    ...
    \`
          ...
          <div class="nav-row">
            <wa-button href="/guide/routing">&larr; Routing</wa-button>
            <wa-button href="/guide/ssg">SSG Guide &rarr;</wa-button>
          </div>
        </div>
      </app-layout>
    `
