...
if (typeof globalThis.URLPattern === 'undefined') {
  // The route table below constructs URLPattern objects at module scope;
  // Node < 24 lacks the global (23.8+ exposes it on node:url). Polyfill the
  // global when possible, else fail with guidance instead of a raw
  // ReferenceError.
  try {
