 ...
 * semantic brand/text/bg/border tokens) that all openElement components
 * can adopt via \`static styles\`.
 *
...
:host {
  ...
  --brand-pale: var(--violet-1);
  --brand-deep: var(--violet-11);
  --brand-subtle: color-mix(in srgb, var(--brand) 12%, transparent);
  ...
  --tooltip-padding: var(--size-1) var(--size-2);
