/**
 * ./index.ts - Streaming Dsd Renderer.
 *
 ...
 *
 * @module ./render-dsd-stream.ts
 */

import { renderDsd, safeNow } from './render-dsd.ts';
import type { RenderError, RenderOutput } from '../protocol/render.ts';
...
export interface RenderDsdStreamComponent {
  ...
  dsdOptions?: import('../protocol/render.ts').DsdOptions;
}
